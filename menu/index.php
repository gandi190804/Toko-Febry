...
function tampilkanMenu($connection, $kategori)
{
  ...
  if ($result->num_rows > 0) {
    while ($row = $result->fetch_assoc()) {
      ...
      $buttonClass = $stokTersedia ? 'btn-info' : 'btn-info';
      ...
      echo "<h2 class='card-title text-start text-truncate' style='font-weight: 600;    overflow: hidden;
      white-space: nowrap;
      text-overflow: ellipsis;'>" . htmlspecialchars($row['nama_menu']) . "</h2>";
        ...
        <div class="offcanvas offcanvas-start" tabindex="-1" id="offcanvasNavbar" aria-labelledby="offcanvasNavbarLabel">
          ...
          <div class="offcanvas-body">
            <ul class="navbar-nav justify-content-end flex-grow-1 pe-3 gap-2">
              ...
              <li class="nav-item bg-secondary-subtle rounded">
                <a class="nav-link p-2 d-flex align-items-center gap-3" href="../lokasi/index.php">
  ...
  <main>
    ...
    <div class="border-top border-bottom border-secondary-subtle" id="section-asin">
      <div class="d-flex justify-content-between gap-3 py-3 px-2">
        ...
        <a href="menu-kategori.php?kategori=asin" class="text-body">
          <i class="fa-solid fa-chevron-right"></i>
        </a>
      </div>
    </div>
    ...
    <div class="border-top border-bottom border-secondary-subtle" id="section-pedas">
      <div class="d-flex justify-content-between gap-3 py-3 px-2">
        ...
        <a href="menu-kategori.php?kategori=pedas" class="text-body">
          <i class="fa-solid fa-chevron-right"></i>
        </a>
      </div>
    </div>
    ...
    <div class="border-top border-bottom border-secondary-subtle" id="section-kerupuk">
      <div class="d-flex justify-content-between gap-3 py-3 px-2">
        ...
        <a href="menu-kategori.php?kategori=kerupuk" class="text-body">
          <i class="fa-solid fa-chevron-right"></i>
        </a>
      </div>
    </div>
    ...
    <div class="border-top border-bottom border-secondary-subtle" id="section-biskuit">
      <div class="d-flex justify-content-between gap-3 py-3 px-2">
        ...
        <a href="menu-kategori.php?kategori=biskuit" class="text-body">
          <i class="fa-solid fa-chevron-right"></i>
        </a>
      </div>
    </div>
    ...
    <div class="border-top border-bottom border-secondary-subtle" id="section-kacang">
      <div class="d-flex justify-content-between gap-3 py-3 px-2">
        ...
        <a href="menu-kategori.php?kategori=kacang" class="text-body">
          <i class="fa-solid fa-chevron-right"></i>
        </a>
      </div>
    </div>
    ...
    <div class="border-top border-bottom border-secondary-subtle" id="section-permen">
      <div class="d-flex justify-content-between gap-3 py-3 px-2">
        ...
        <a href="menu-kategori.php?kategori=permen" class="text-body">
          <i class="fa-solid fa-chevron-right"></i>
        </a>
      </div>
    </div>
        ...
        button.addEventListener('click', function() {
          ...
          getMenuInfo(productId)
            .then(menu => {
              ...
              // Tampilkan berat makanan + gram jika penjualan adalah 'Berat'
              ...
              // Tampilkan berat makanan + bungkus jika penjualan adalah 'Bungkus'
