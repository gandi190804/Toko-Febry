...
if (isset($_POST['submit'])) {
    ...
    $stmt = $connection->prepare("SELECT * FROM viewers WHERE username = ? AND deleted_at IS NULL LIMIT 1");
            ...
            <div class="login-container w-100" style="margin-top: 30px;">
                ...
                <form action="#" style="font-size: 20px; margin-top: 40px;" method="post">
                    ...
                    <div class="text-center" style="margin-top: 20px;">
                        <p>Belum memiliki akun? <a href="signup.php" style="color: #03C3EC; font-weight: bold;">Sign Up</a></p>
                    </div>
                </form>
            </div>
        </section>
