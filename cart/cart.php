...
$query = "SELECT cart.*, menus.nama_menu, menus.harga, menus.foto_menu, menus.penjualan, menus.berat_makanan 
          FROM cart 
          INNER JOIN menus ON cart.id_menu = menus.id
        ...
        <div class="w-100 d-block">
            <div class="row justify-content-between">
                <div class="col-auto d-flex align-items-center gap-3">
                    <a href="../pencatatan/pencatatan-masuk.php" class="text-dark bg-secondary-subtle py-1 px-2 rounded"><i class="fa-solid fa-chevron-left"></i></a>
    ...
    <main>
        ...
        <div class="p-3 d-flex align-items-center justify-content-between" id="bawah-keranjang">
            ...
            <div class="d-flex align-items-center gap-2">
                <a href="../pencatatan/pencatatan-masuk.php">
            ...
            <div class="justify-content-center" style="width: 100%;">
                <div class="d-flex align-items-center p-3 justify-content-between">
                    ...
                    <div class="d-flex align-items-center gap-2">
                        ...
                        <h4 class="harga-hasil" style="color: red; font-size: 18px;" name="hasil">Rp<?php echo number_format($totalHarga, 0, ',', '.'); ?></h4>
                    </div>
                </div>
                <div class="col-auto d-flex align-items-center mb-3 gap-3" id="btn-keranjang">
                    <a style="width: 100%;">
                        <button class="btn w-100" style="background-color: #03C3EC; width: 100%;" type="button" id="btn-catat">Catat</button>
                    </a>
                </div>
            </div>
        </div>
