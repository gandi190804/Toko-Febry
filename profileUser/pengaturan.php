...
if (!isset($_SESSION['loginUser'])) {
  header("Location: ../authUser/login.php"); // Redirect ke halaman login jika belum login
  exit();
}
?>
  ...
  <div>
    ...
    <div class="p-3" style="border: none;">
      <div class="text-center p-3">
        ...
        <div class="row row-cols-2" style="margin-top: 2%;">
          <div class="col text-start">
      ...
      btnlogoutAkun.addEventListener('click', function() {
        ...
        Swal.fire({
          ...
          if (result.isConfirmed) {
            ...
            window.location.href = "../authUser/logout.php";
          }
        });
      });
    });
