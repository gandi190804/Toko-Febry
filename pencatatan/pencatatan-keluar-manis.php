...
function tampilkanMenu($connection, $kategori)
{
  ...
  if ($result->num_rows > 0) {
    while ($row = $result->fetch_assoc()) {
      ...
      echo "<div class='card $cardClass p-0 border rounded'>";
      echo "<img src='../image/foto_menu/" . htmlspecialchars($row['foto_menu']) . "' class='card-img-top img-fluid rounded-top' alt=''>";
      echo "<div class='card-body d-flex flex-column justify-content-center p-3'>";
    ...
    <div class="py-1 mx-3 w-100 d-block">
      <div class="row justify-content-between">
        ...
        <div class="col-auto d-flex align-items-center gap-3">
          <a href="./pencatatan-keluar.php" class="text-dark bg-secondary-subtle py-1 px-2 rounded"><i class="fa-solid fa-chevron-left"></i></a>
