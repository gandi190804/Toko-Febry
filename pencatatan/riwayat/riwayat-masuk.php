...
// Base query
$query = "SELECT * FROM pencatatan WHERE id_user = '$id_user'";

// Add filter based on payment method if selected
...
<body style="font-family: 'Poppins', sans-serif;">
    ...
    <div class="w-100 d-block">
      <div class="row justify-content-between">
        <div class="col-auto d-flex align-items-center gap-3">
          ...
          <h1 class="m-0" style="font-weight: 600;">Riwayat Pemasukan</h1>
        </div>
            ...
            <ul class="navbar-nav justify-content-end flex-grow-1 pe-3 gap-2">
              ...
              <li class="nav-item dropdown bg-secondary-subtle rounded">
                ...
                <ul class="dropdown-menu bg-secondary-subtle">
                  ...
                  <li><a class="dropdown-item" href="./riwayat-keluar.php">Pengeluaran</a></li>
                </ul>
              </li>
              <li class="nav-item bg-secondary-subtle rounded">
  ...
  <div class="select-menu p-3">
    <form method="GET" action="riwayat-masuk.php">
        ...
        <div class="card mb-3">
          ...
          <div class="card-body2 p-3 d-flex justify-content-between align-items-center">
            <div>
              ...
              <a href="../detail-masuk.php?id=<?php echo $id; ?>" style="text-decoration: none;">
                <h2 class="card-title text-danger" id="detail" style="text-decoration: none;">detail</h2>
              </a>
            </div>
            <div>
              <!-- Detail lainnya disini -->
            </div>
          </div>
        </div>
    <?php
      ...
      // Jika tidak ada data riwayat pemasukan
      echo "<p>Tidak ada riwayat pemasukan.</p>";
    }
    ?>
  </div>
