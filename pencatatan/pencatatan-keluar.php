...
{
  $query = "SELECT * FROM menus WHERE kategori_menu = ? AND deleted_at IS NULL";
  ...
  if ($result->num_rows > 0) {
    while ($row = $result->fetch_assoc()) {
      ...
      $cardClass = $stokTersedia ? 'card-barang' : 'card-barang not-available';
      ...
      echo "<p class='card-text text-start text-truncate' style='color: #03C3EC;'>" . ($stokTersedia ? 'Tersedia' : 'Tidak Tersedia') . "</p>";
...
<body>
    ...
    <div class="py-1 mx-3 w-100 d-block">
      <div class="row justify-content-between">
        <div class="d-flex align-items-center justify-content-between">
          ...
          <h1 class="m-0 text-start ms-2 flex-grow-1" style="font-weight: 600;">Pencatatan Pengeluaran</h1>
          <div class="d-flex align-items-center">
            <a href="../cart/cart-pengeluaran.php" class="text-dark bg-secondary-subtle py-1 px-2 rounded"><i class="fa-solid fa-cart-shopping"></i></a>
          </div>
        </div>
  ...
  <div class="m-3">
    <div class="swiper my-4 user-select-none py-1">
      <div class="swiper-wrapper">
        <div class="swiper-slide">
          <a href="javascript:void(0);" class="text-decoration-none text-body scroll-btn" data-target="#section-manis">
            <small class="border border-secondary-subtle rounded-pill px-3 py-1">
              Manis</small>
          </a>
        </div>
        <div class="swiper-slide">
          <a href="javascript:void(0);" class="text-decoration-none text-body scroll-btn" data-target="#section-asin">
            <small class="border border-secondary-subtle rounded-pill px-3 py-1">
              Asin</small>
          </a>
        </div>
        <div class="swiper-slide">
          <a href="javascript:void(0);" class="text-decoration-none text-body scroll-btn" data-target="#section-pedas">
            <small class="border border-secondary-subtle rounded-pill px-3 py-1">
              Pedas</small>
          </a>
        </div>
        <div class="swiper-slide">
          <a href="javascript:void(0);" class="text-decoration-none text-body scroll-btn" data-target="#section-kerupuk">
            <small class="border border-secondary-subtle rounded-pill px-3 py-1">
              Kerupuk</small>
          </a>
        </div>
        <div class="swiper-slide">
          <a href="javascript:void(0);" class="text-decoration-none text-body scroll-btn" data-target="#section-biskuit">
            <small class="border border-secondary-subtle rounded-pill px-3 py-1">
              Biskuit</small>
          </a>
        </div>
        <div class="swiper-slide">
          <a href="javascript:void(0);" class="text-decoration-none text-body scroll-btn" data-target="#section-kacang">
            <small class="border border-secondary-subtle rounded-pill px-3 py-1">
              Kacang</small>
          </a>
        </div>
        <div class="swiper-slide">
          <a href="javascript:void(0);" class="text-decoration-none text-body scroll-btn" data-target="#section-permen">
            <small class="border border-secondary-subtle rounded-pill px-3 py-1">
              Permen</small>
          </a>
        </div>
  ...
  <main>
    <div class="border-top border-bottom border-secondary-subtle" id="section-manis">
      <div class="d-flex justify-content-between gap-3 py-3 px-2">
        <h1 class="m-0">Manis</h1>
        <a href="pencatatan-keluar-manis.php?kategori=manis" class="text-body">
          <i class="fa-solid fa-chevron-right"></i>
        </a>
      </div>
    </div>
    <div class="swiper my-4 user-select-none py-1 mx-3">
      <div class="swiper-wrapper">
        <?php tampilkanMenu($connection, 'manis'); ?>
      </div>
      <!-- Add Pagination -->
      <div class="swiper-pagination"></div>
    </div>

    <div class="border-top border-bottom border-secondary-subtle" id="section-asin">
      <div class="d-flex justify-content-between gap-3 py-3 px-2">
        <h1 class="m-0">Asin</h1>
        <a href="pencatatan-keluar-manis.php?kategori=asin" class="text-body">
          <i class="fa-solid fa-chevron-right"></i>
        </a>
      </div>
    </div>
    <div class="swiper my-4 user-select-none py-1 mx-3">
      <div class="swiper-wrapper">
        <?php tampilkanMenu($connection, 'asin'); ?>
      </div>
      <!-- Add Pagination -->
      <div class="swiper-pagination"></div>
    </div>

    <div class="border-top border-bottom border-secondary-subtle" id="section-pedas">
      <div class="d-flex justify-content-between gap-3 py-3 px-2">
        <h1 class="m-0">Pedas</h1>
        <a href="pencatatan-keluar-manis.php?kategori=pedas" class="text-body">
          <i class="fa-solid fa-chevron-right"></i>
        </a>
      </div>
    </div>
    <div class="swiper my-4 user-select-none py-1 mx-3">
      <div class="swiper-wrapper">
        <?php tampilkanMenu($connection, 'pedas'); ?>
      </div>
      <!-- Add Pagination -->
      <div class="swiper-pagination"></div>
    </div>

    <div class="border-top border-bottom border-secondary-subtle" id="section-kerupuk">
      <div class="d-flex justify-content-between gap-3 py-3 px-2">
        <h1 class="m-0">Kerupuk</h1>
        <a href="pencatatan-keluar-manis.php?kategori=kerupuk" class="text-body">
          <i class="fa-solid fa-chevron-right"></i>
        </a>
      </div>
    </div>
    <div class="swiper my-4 user-select-none py-1 mx-3">
      <div class="swiper-wrapper">
        <?php tampilkanMenu($connection, 'kerupuk'); ?>
      </div>
      <!-- Add Pagination -->
      <div class="swiper-pagination"></div>
    </div>

    <div class="border-top border-bottom border-secondary-subtle" id="section-biskuit">
      <div class="d-flex justify-content-between gap-3 py-3 px-2">
        <h1 class="m-0">Biskuit</h1>
        <a href="pencatatan-keluar-manis.php?kategori=biskuit" class="text-body">
          <i class="fa-solid fa-chevron-right"></i>
        </a>
      </div>
    </div>
    <div class="swiper my-4 user-select-none py-1 mx-3">
      <div class="swiper-wrapper">
        <?php tampilkanMenu($connection, 'biskuit'); ?>
      </div>
      <!-- Add Pagination -->
      <div class="swiper-pagination"></div>
    </div>

    <div class="border-top border-bottom border-secondary-subtle" id="section-kacang">
      <div class="d-flex justify-content-between gap-3 py-3 px-2">
        <h1 class="m-0">Kacang</h1>
        <a href="pencatatan-keluar-manis.php?kategori=kacang" class="text-body">
          <i class="fa-solid fa-chevron-right"></i>
        </a>
      </div>
    </div>
    <div class="swiper my-4 user-select-none py-1 mx-3">
      <div class="swiper-wrapper">
        <?php tampilkanMenu($connection, 'kacang'); ?>
      </div>
      <!-- Add Pagination -->
      <div class="swiper-pagination"></div>
    </div>

    <div class="border-top border-bottom border-secondary-subtle" id="section-permen">
      <div class="d-flex justify-content-between gap-3 py-3 px-2">
        <h1 class="m-0">Permen</h1>
        <a href="pencatatan-keluar-manis.php?kategori=permen" class="text-body">
          <i class="fa-solid fa-chevron-right"></i>
        </a>
      </div>
    </div>
    <div class="swiper my-4 user-select-none py-1 mx-3">
      <div class="swiper-wrapper">
        <?php tampilkanMenu($connection, 'permen'); ?>
      </div>
      <!-- Add Pagination -->
      <div class="swiper-pagination"></div>
    </div>
        ...
        <div class="container" style="margin-top: 10px;">
          <div class="row">
            ...
            <div class="col-md-6">
              ...
              <div class=" p-lg-4 p-3 ps-4 d-flex border-bottom border-top">
          ...
          getMenuInfo(productId)
            .then(menu => {
              ...
              function tambahkanKeKeranjang(productId) {
                const jumlahPengeluaranInput = document.querySelector('#jumlah_pengeluaran');
                const jumlahPengeluaran = jumlahPengeluaranInput.value;

                const data = new FormData();
                data.append('id_menu', productId);
                data.append('jumlah_pengeluaran', jumlahPengeluaran);

                fetch('store-cart-pengeluaran.php', {
                    method: 'POST',
                    body: data
                  })
                  ...
                  .then(data => {
                    if (data.status === 'success') {
                      ...
                      Swal.fire('Gagal!', 'Gagal menambahkan pesanan!', 'error');
                    }
                  })
                  .catch(error => {
    ...
    document.addEventListener('DOMContentLoaded', function() {
      ...
      window.addEventListener('scroll', function() {
        ...
        if (scrollY > navbarHeight) {
          ...
          contentSection.style.marginTop = '0';
        }
      });
