...
function tampilkanMenu($connection, $kategori)
{
  ...
  if ($result->num_rows > 0) {
    while ($row = $result->fetch_assoc()) {
      ...
      echo "<h2 class='card-title text-start text-truncate' style='font-weight: 600; overflow: hidden; white-space: nowrap; text-overflow: ellipsis; max-width: 100%;'>" . htmlspecialchars($row['nama_menu']) . "</h2>";
      // Sisanya tetap sama
    ...
    <div class="py-1 mx-3 w-100 d-block">
      <div class="row justify-content-between">
        <div class="col-auto d-flex align-items-center gap-3">
          ...
          <h1 class="m-0" style="font-weight: 600;">Pencatatan Pemasukan</h1>
        </div>
            ...
            <ul class="navbar-nav justify-content-end flex-grow-1 pe-3 gap-2">
              ...
              <li class="nav-item dropdown bg-secondary-subtle rounded">
                ...
                <ul class="dropdown-menu bg-secondary-subtle">
                  ...
                  <li><a class="dropdown-item" href="./pencatatan-keluar.php">Pengeluaran</a></li>
                </ul>
              </li>
              <li class="nav-item bg-secondary-subtle rounded">
  ...
  <main>
    <div class="border-top border-bottom border-secondary-subtle" id="section-manis">
      <div class="d-flex justify-content-between gap-3 py-3 px-2">
        <h5 class="m-0">Manis</h5>
        <a href="pencatatan-masuk-manis.php?kategori=manis" class="text-body">
    ...
    <div class="border-top border-bottom border-secondary-subtle" id="section-asin">
      <div class="d-flex justify-content-between gap-3 py-3 px-2">
        <h5 class="m-0">Asin</h5>
        <a href="pencatatan-masuk-manis.php?kategori=asin" class="text-body">
          <i class="fa-solid fa-chevron-right"></i>
        </a>
      </div>
    </div>
    ...
    <div class="border-top border-bottom border-secondary-subtle" id="section-pedas">
      <div class="d-flex justify-content-between gap-3 py-3 px-2">
        <h5 class="m-0">Pedas</h5>
        <a href="pencatatan-masuk-manis.php?kategori=pedas" class="text-body">
          <i class="fa-solid fa-chevron-right"></i>
        </a>
      </div>
    </div>
    ...
    <div class="border-top border-bottom border-secondary-subtle" id="section-kerupuk">
      <div class="d-flex justify-content-between gap-3 py-3 px-2">
        <h5 class="m-0">Kerupuk</h5>
        <a href="pencatatan-masuk-manis.php?kategori=kerupuk" class="text-body">
          <i class="fa-solid fa-chevron-right"></i>
        </a>
      </div>
    </div>
    ...
    <div class="border-top border-bottom border-secondary-subtle" id="section-biskuit">
      <div class="d-flex justify-content-between gap-3 py-3 px-2">
        <h5 class="m-0">Biskuit</h5>
        <a href="pencatatan-masuk-manis.php?kategori=biskuit" class="text-body">
          <i class="fa-solid fa-chevron-right"></i>
        </a>
      </div>
    </div>
    ...
    <div class="border-top border-bottom border-secondary-subtle" id="section-kacang">
      <div class="d-flex justify-content-between gap-3 py-3 px-2">
        <h5 class="m-0">Kacang</h5>
        <a href="pencatatan-masuk-manis.php?kategori=kacang" class="text-body">
          <i class="fa-solid fa-chevron-right"></i>
        </a>
      </div>
    </div>
    ...
    <div class="border-top border-bottom border-secondary-subtle" id="section-permen">
      <div class="d-flex justify-content-between gap-3 py-3 px-2">
        <h5 class="m-0">Permen</h5>
        <a href="pencatatan-masuk-manis.php?kategori=permen" class="text-body">
          <i class="fa-solid fa-chevron-right"></i>
        </a>
      </div>
    </div>
          ...
          getMenuInfo(productId)
            .then(menu => {
              ...
              function updateHarga() {
                ...
                hargaContainer.textContent = 'Rp' + totalHarga.toFixed(2);
              }
