        ...
        <form action="./update-profile.php" method="post" enctype="multipart/form-data">
            <div class="row align-items-center">
                <div class="col-md-6 text-center">
                    <img src="../image/foto_profile/<?= $user['foto_user'] ?>" class="rounded img-fluid symmetrical-img" alt="Foto Profil">
                </div>
            ...
            <div class="mb-3 mt-3">
                ...
                <input type="text" class="form-control" id="inputUsername" name="nama" value="<?php echo htmlspecialchars($user['nama']); ?>" required>
            </div>
            <div class="mb-3">
