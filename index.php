...
$userName = $_SESSION['loginUser']['nama'];
        ...
        <div class="py-1 mx-3 w-100 d-block">
            <div class="row justify-content-between">
                <div class="col-auto d-flex align-items-center gap-3">
                    ...
                    <h1 class="m-0" style="font-weight: 600;">Menu</h1>
                </div>

                <div class="col-auto d-flex align-items-center">
                    <a href="keranjang.php" class="text-dark bg-secondary-subtle py-1 px-2 rounded"><i class="fa-solid fa-cart-shopping"></i></a>
                </div>
                <div class="offcanvas offcanvas-start" tabindex="-1" id="offcanvasNavbar" aria-labelledby="offcanvasNavbarLabel">
                    ...
                    <div class="offcanvas-body">
                        <ul class="navbar-nav justify-content-end flex-grow-1 pe-3 gap-2">
                            ...
                            <li class="nav-item bg-secondary-subtle rounded">
                                <a class="nav-link p-2 d-flex align-items-center gap-3" href="profileUser/pengaturan.php">
    ...
    <main>
        <div class="border-top border-bottom border-secondary-subtle" id="section-manis">
            <div class="d-flex justify-content-between gap-3 py-3 px-2">
                ...
                <a href="menu-kategori.php?kategori=manis" class="text-body">
